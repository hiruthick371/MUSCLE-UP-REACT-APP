...
function Header(props){
  ...
  return(<>
      <div className='flex flex-col gap-4 '>
        ...
        <p className='text-am sm:text-base mx-auto'>{description}</p>
      </div>
...
export default function Generator(props) {
  ...
  //let showModal = false; //We have to use UseState hook to interact with elements in React
  ...
  return (
    <SectionWrapper id={'generate'} header={"generate your workout"} title={['It\'s','Huge','O\'Clock']}>
     ...
     {Object.keys(WORKOUTS).map((type,typeIndex)=>{
      ...
      <Header index={'02'} title={"Lock In"} description={'Select the muscles judged for annihilation'}
      />
    ...
    <Header index={'03'} title={"GRIND"} description={'Select your ultimate objective.'}
      />
